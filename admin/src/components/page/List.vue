...
const emit = defineEmits(['emitPageDelete', 'emitVisiblePage', 'emitHiddenPage']);

const emitPageDelete = (page: any) => {
    emit('emitPageDelete', page);
};
const emitVisiblePage = (page: any) => {
    emit('emitVisiblePage', page);
};
const emitHiddenPage = (page: any) => {
    emit('emitHiddenPage', page);
};
</script>
