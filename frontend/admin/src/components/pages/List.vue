<template>
	<div class="pages-list-item text-14px w-full text-gray-300">
		...
		<div
			...
			:key="page.id"
		>
			<router-link :to="`pages/${page.id}`" class="absolute inset-0 z-10"></router-link>
